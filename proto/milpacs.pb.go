...
const file_milpacs_proto_rawDesc = "" +
	...
	"\x06Thingy\x12\x10\n" +
	"\x03ack\x18\x01 \x01(\tR\x03ack\"\x96\x04\n" +
	"\aProfile\x12\x1f\n" +
	...
	"\x14last_forum_post_date\x18\x0e \x01(\tR\x11lastForumPostDate\":\n" +
	"\rRosterRequest\x12)\n" +
	...
	"recordDate\x12/\n" +
	"\x14last_forum_post_date\x18\x0e \x01(\tR\x11lastForumPostDate\"\x9a\x01\n" +
	"\n" +
	"LiteRoster\x12;\n" +
	...
	"\fAwolResponse\x12!\n" +
	"\x05awols\x18\x01 \x03(\v2\v.proto.AwolR\x05awols\"\xcd\x01\n" +
	"\x04Awol\x12\x1d\n" +
	"\n" +
	...
	"\apost_id\x18\a \x01(\x04R\x06postId\"-\n" +
	...
	"\x19Roster, Milpacs, Gamertag\x12!Get a Milpac profile via Gamertag\x1a?Get all milpac Profile data for a given user via their Gamertag\x82\xd3\xe4\x93\x02$\x12\"/api/v1/milpac/gamertag/{gamertag}B\xc8\x01\x92A\xa9\x01\x12\a2\x051.7.2*\x01\x02ZY\n" +
	"W\n" +
