...
const (
	...
	MilpacService_GetGamertagProfile_FullMethodName   = "/proto.MilpacService/GetGamertagProfile"
)
...
type MilpacServiceClient interface {
	...
	GetGamertagProfile(ctx context.Context, in *GamertagRequest, opts ...grpc.CallOption) (*Profile, error)
}
...
func (c *milpacServiceClient) GetGamertagProfile(ctx context.Context, in *GamertagRequest, opts ...grpc.CallOption) (*Profile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Profile)
	err := c.cc.Invoke(ctx, MilpacService_GetGamertagProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MilpacServiceServer interface {
	...
	GetGamertagProfile(context.Context, *GamertagRequest) (*Profile, error)
}
...
func (UnimplementedMilpacServiceServer) GetUserViaKeycloakId(context.Context, *KeycloakIdRequest) (*Profile, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUserViaKeycloakId not implemented")
}
func (UnimplementedMilpacServiceServer) GetUserViaDiscordId(context.Context, *DiscordIdRequest) (*Profile, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUserViaDiscordId not implemented")
}
func (UnimplementedMilpacServiceServer) GetLiteRoster(context.Context, *RosterRequest) (*LiteRoster, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLiteRoster not implemented")
}
func (UnimplementedMilpacServiceServer) SearchByPosition(context.Context, *PositionSearchRequest) (*LiteRoster, error) {
	return nil, status.Error(codes.Unimplemented, "method SearchByPosition not implemented")
}
func (UnimplementedMilpacServiceServer) GetS1UniformsRoster(context.Context, *RosterRequest) (*S1UniformsRoster, error) {
	return nil, status.Error(codes.Unimplemented, "method GetS1UniformsRoster not implemented")
}
func (UnimplementedMilpacServiceServer) GetAllRanks(context.Context, *emptypb.Empty) (*RanksResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAllRanks not implemented")
}
func (UnimplementedMilpacServiceServer) GetPositionGroups(context.Context, *emptypb.Empty) (*PositionGroupsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPositionGroups not implemented")
}
func (UnimplementedMilpacServiceServer) GetAwol(context.Context, *emptypb.Empty) (*AwolResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAwol not implemented")
}
func (UnimplementedMilpacServiceServer) GetGamertagProfile(context.Context, *GamertagRequest) (*Profile, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGamertagProfile not implemented")
}
...
func RegisterMilpacServiceServer(s grpc.ServiceRegistrar, srv MilpacServiceServer) {
	// If the following call panics, it indicates UnimplementedMilpacServiceServer was
...
func _MilpacService_GetGamertagProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GamertagRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MilpacServiceServer).GetGamertagProfile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MilpacService_GetGamertagProfile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MilpacServiceServer).GetGamertagProfile(ctx, req.(*GamertagRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MilpacService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetGamertagProfile",
			Handler:    _MilpacService_GetGamertagProfile_Handler,
		},
	},
